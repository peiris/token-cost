...
argument-hint: "[tasks|sessions|days|ui|html] [today|week|month]"
...
Sometimes the output is a table and sometimes it is a short message — for example, when the UI has been opened in its own window, or the full report in the browser. Print whichever one you got, the same way.
